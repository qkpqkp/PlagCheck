...
class SFC64(__numpy_random__bit_generator.BitGenerator):
    """
    SFC64(seed=None)
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001B87A5291B0>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001B87A526EB8>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy.random._sfc64', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001B87A526EB8>, origin='C:\\\\Users\\\\Doly\\\\Anaconda3\\\\lib\\\\site-packages\\\\numpy\\\\random\\\\_sfc64.cp37-win_amd64.pyd')"
