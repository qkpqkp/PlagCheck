...
class FDCapture(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'py._io.capture', '__doc__': ' Capture IO to/from a given os-level filedescriptor. ', '__init__': <function FDCapture.__init__ at 0x000001C51FB738C8>, 'start': <function FDCapture.start at 0x000001C51FB73E18>, 'done': <function FDCapture.done at 0x000001C51FB73D08>, 'writeorg': <function FDCapture.writeorg at 0x000001C51FB73EA0>, '__dict__': <attribute '__dict__' of 'FDCapture' objects>, '__weakref__': <attribute '__weakref__' of 'FDCapture' objects>})"
...
class TerminalWriter(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'py._io.terminalwriter', '_esctable': {'black': 30, 'red': 31, 'green': 32, 'yellow': 33, 'blue': 34, 'purple': 35, 'cyan': 36, 'white': 37, 'Black': 40, 'Red': 41, 'Green': 42, 'Yellow': 43, 'Blue': 44, 'Purple': 45, 'Cyan': 46, 'White': 47, 'bold': 1, 'light': 2, 'blink': 5, 'invert': 7}, '__init__': <function TerminalWriter.__init__ at 0x000001C51FB7A1E0>, 'fullwidth': <property object at 0x000001C51FF50D68>, 'chars_on_current_line': <property object at 0x000001C51FF50F48>, 'width_of_current_line': <property object at 0x000001C51FF50DB8>, '_escaped': <function TerminalWriter._escaped at 0x000001C51FB7A488>, 'markup': <function TerminalWriter.markup at 0x000001C51FB7A510>, 'sep': <function TerminalWriter.sep at 0x000001C51FB7A598>, 'write': <function TerminalWriter.write at 0x000001C51FB7A620>, '_update_chars_on_current_line': <function TerminalWriter._update_chars_on_current_line at 0x000001C51FB7A6A8>, 'line': <function TerminalWriter.line at 0x000001C51FB7A730>, 'reline': <function TerminalWriter.reline at 0x000001C51FB7A7B8>, '_checkfill': <function TerminalWriter._checkfill at 0x000001C51FB7A840>, '__dict__': <attribute '__dict__' of 'TerminalWriter' objects>, '__weakref__': <attribute '__weakref__' of 'TerminalWriter' objects>, '__doc__': None})"
