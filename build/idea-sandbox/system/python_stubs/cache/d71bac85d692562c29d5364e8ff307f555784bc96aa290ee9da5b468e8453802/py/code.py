...
class Code(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'py._code.code', '__doc__': ' wrapper around Python code objects ', '__init__': <function Code.__init__ at 0x000001C51FB559D8>, '__eq__': <function Code.__eq__ at 0x000001C51FB55A60>, '__ne__': <function Code.__ne__ at 0x000001C51FB55AE8>, 'path': <property object at 0x000001C51FB5FDB8>, 'fullsource': <property object at 0x000001C51FB5FE08>, 'source': <function Code.source at 0x000001C51FB55C80>, 'getargs': <function Code.getargs at 0x000001C51FB55D08>, '__dict__': <attribute '__dict__' of 'Code' objects>, '__weakref__': <attribute '__weakref__' of 'Code' objects>, '__hash__': None})"
    __hash__ = None
...
class ExceptionInfo(object):
    ...
    _striptext = ''
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'py._code.code', '__doc__': ' wraps sys.exc_info() objects and offers\\n        help for navigating the traceback.\\n    ', '_striptext': '', '__init__': <function ExceptionInfo.__init__ at 0x000001C51FB6AD08>, '__repr__': <function ExceptionInfo.__repr__ at 0x000001C51FB6AD90>, 'exconly': <function ExceptionInfo.exconly at 0x000001C51FB6AE18>, 'errisinstance': <function ExceptionInfo.errisinstance at 0x000001C51FB6AEA0>, '_getreprcrash': <function ExceptionInfo._getreprcrash at 0x000001C51FB6AF28>, 'getrepr': <function ExceptionInfo.getrepr at 0x000001C51FB6C048>, '__str__': <function ExceptionInfo.__str__ at 0x000001C51FB6C0D0>, '__unicode__': <function ExceptionInfo.__unicode__ at 0x000001C51FB6C158>, '__dict__': <attribute '__dict__' of 'ExceptionInfo' objects>, '__weakref__': <attribute '__weakref__' of 'ExceptionInfo' objects>})"
...
class Frame(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'py._code.code', '__doc__': 'Wrapper around a Python frame holding f_locals and f_globals\\n    in which expressions can be evaluated.', '__init__': <function Frame.__init__ at 0x000001C51FB55D90>, 'statement': <property object at 0x000001C51FB5FF98>, 'eval': <function Frame.eval at 0x000001C51FB55EA0>, 'exec_': <function Frame.exec_ at 0x000001C51FB55F28>, 'repr': <function Frame.repr at 0x000001C51FB6A048>, 'is_true': <function Frame.is_true at 0x000001C51FB6A0D0>, 'getargs': <function Frame.getargs at 0x000001C51FB6A158>, '__dict__': <attribute '__dict__' of 'Frame' objects>, '__weakref__': <attribute '__weakref__' of 'Frame' objects>})"
...
class Source(object):
    ...
    _compilecounter = 0
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'py._code.source', '__doc__': ' a immutable object holding a source code fragment,\\n        possibly deindenting it.\\n    ', '_compilecounter': 0, '__init__': <function Source.__init__ at 0x000001C51FBB9510>, '__eq__': <function Source.__eq__ at 0x000001C51FBB9730>, '__getitem__': <function Source.__getitem__ at 0x000001C51FBB96A8>, '__len__': <function Source.__len__ at 0x000001C51FBB9620>, '__getslice__': <function Source.__getslice__ at 0x000001C51FBB9840>, 'strip': <function Source.strip at 0x000001C51FBB98C8>, 'putaround': <function Source.putaround at 0x000001C51FBB97B8>, 'indent': <function Source.indent at 0x000001C51FBB9950>, 'getstatement': <function Source.getstatement at 0x000001C51FBB99D8>, 'getstatementrange': <function Source.getstatementrange at 0x000001C51FBB9A60>, 'deindent': <function Source.deindent at 0x000001C51FBB9AE8>, 'isparseable': <function Source.isparseable at 0x000001C51FBB9B70>, '__str__': <function Source.__str__ at 0x000001C51FBB9BF8>, 'compile': <function Source.compile at 0x000001C51FBB9C80>, '__dict__': <attribute '__dict__' of 'Source' objects>, '__weakref__': <attribute '__weakref__' of 'Source' objects>, '__hash__': None})"
    __hash__ = None
...
class Traceback(list):
    ...
    def filter(self, fn='<function Traceback.<lambda> at 0x000001C51FB6AAE8>'): # reliably restored by inspect
        """
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'py._code.code', '__doc__': ' Traceback objects encapsulate and offer higher level\\n        access to Traceback entries.\\n    ', 'Entry': <class 'py._code.code.TracebackEntry'>, '__init__': <function Traceback.__init__ at 0x000001C51FB6A950>, 'cut': <function Traceback.cut at 0x000001C51FB6A9D8>, '__getitem__': <function Traceback.__getitem__ at 0x000001C51FB6AA60>, 'filter': <function Traceback.filter at 0x000001C51FB6AB70>, 'getcrashentry': <function Traceback.getcrashentry at 0x000001C51FB6ABF8>, 'recursionindex': <function Traceback.recursionindex at 0x000001C51FB6AC80>, '__dict__': <attribute '__dict__' of 'Traceback' objects>, '__weakref__': <attribute '__weakref__' of 'Traceback' objects>})"
