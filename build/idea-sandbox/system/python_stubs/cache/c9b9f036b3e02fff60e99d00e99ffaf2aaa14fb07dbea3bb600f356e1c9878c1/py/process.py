...
class ForkedFunc(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'py._process.forkedfunc', 'EXITSTATUS_EXCEPTION': 3, '__init__': <function ForkedFunc.__init__ at 0x000001AC38AA28C8>, '_child': <function ForkedFunc._child at 0x000001AC38AA2950>, 'waitfinish': <function ForkedFunc.waitfinish at 0x000001AC38AA29D8>, '_removetemp': <function ForkedFunc._removetemp at 0x000001AC38AA2A60>, '__del__': <function ForkedFunc.__del__ at 0x000001AC38AA2AE8>, '__dict__': <attribute '__dict__' of 'ForkedFunc' objects>, '__weakref__': <attribute '__weakref__' of 'ForkedFunc' objects>, '__doc__': None})"
