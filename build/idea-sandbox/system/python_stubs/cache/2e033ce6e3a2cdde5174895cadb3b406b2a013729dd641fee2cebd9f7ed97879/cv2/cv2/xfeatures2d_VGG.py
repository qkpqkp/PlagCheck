...
class xfeatures2d_VGG(__cv2.Feature2D):
    # no doc
    def create(self, desc=None, isigma=None, img_normalize=None, use_scale_orientation=None, scale_factor=None, dsc_normalize=None): # real signature unknown; restored from __doc__
        """
    ...
    def getUseNormalizeDescriptor(self): # real signature unknown; restored from __doc__
        """
    ...
    def getUseNormalizeImage(self): # real signature unknown; restored from __doc__
        """
    ...
    def setSigma(self, isigma): # real signature unknown; restored from __doc__
        """
    ...
    def setUseNormalizeDescriptor(self, dsc_normalize): # real signature unknown; restored from __doc__
        """
    ...
    def setUseNormalizeImage(self, img_normalize): # real signature unknown; restored from __doc__
        """
