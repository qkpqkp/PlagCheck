...
class xfeatures2d_HarrisLaplaceFeatureDetector(__cv2.Feature2D):
    # no doc
    def create(self, numOctaves=None, corn_thresh=None, DOG_thresh=None, maxCorners=None, num_layers=None): # real signature unknown; restored from __doc__
        """
