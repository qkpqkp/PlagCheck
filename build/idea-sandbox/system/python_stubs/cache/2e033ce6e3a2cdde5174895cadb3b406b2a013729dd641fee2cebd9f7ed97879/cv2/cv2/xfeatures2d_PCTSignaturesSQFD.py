...
class xfeatures2d_PCTSignaturesSQFD(__cv2.Algorithm):
    # no doc
    def computeQuadraticFormDistance(self, _signature0, _signature1): # real signature unknown; restored from __doc__
        """
    ...
    def computeQuadraticFormDistances(self, sourceSignature, imageSignatures, distances): # real signature unknown; restored from __doc__
        """
    ...
    def create(self, distanceFunction=None, similarityFunction=None, similarityParameter=None): # real signature unknown; restored from __doc__
        """
