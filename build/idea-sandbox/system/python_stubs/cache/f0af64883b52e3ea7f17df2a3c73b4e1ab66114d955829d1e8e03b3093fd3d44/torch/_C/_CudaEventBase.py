...
class _CudaEventBase(object):
    # no doc
    def elapsed_time(self, *args, **kwargs): # real signature unknown
        pass

    @classmethod
    def from_ipc_handle(cls, *args, **kwargs): # real signature unknown
        pass

    def ipc_handle(self, *args, **kwargs): # real signature unknown
        pass
    ...
    cuda_event = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
