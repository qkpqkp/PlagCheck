...
class ForkedFunc(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'py._process.forkedfunc', 'EXITSTATUS_EXCEPTION': 3, '__init__': <function ForkedFunc.__init__ at 0x000001D1D8DFAD90>, '_child': <function ForkedFunc._child at 0x000001D1D8DFAE18>, 'waitfinish': <function ForkedFunc.waitfinish at 0x000001D1D8DFAEA0>, '_removetemp': <function ForkedFunc._removetemp at 0x000001D1D8DFAF28>, '__del__': <function ForkedFunc.__del__ at 0x000001D1D8F48048>, '__dict__': <attribute '__dict__' of 'ForkedFunc' objects>, '__weakref__': <attribute '__weakref__' of 'ForkedFunc' objects>, '__doc__': None})"
