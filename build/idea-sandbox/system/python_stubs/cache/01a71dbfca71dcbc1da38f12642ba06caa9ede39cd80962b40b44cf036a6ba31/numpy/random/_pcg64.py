...
class PCG64(__numpy_random__bit_generator.BitGenerator):
    """
    PCG64(seed_seq=None)
    ...
    def __init__(self, seed_seq=None): # real signature unknown; restored from __doc__
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000002347C879180>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000002347C876C18>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy.random._pcg64', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000002347C876C18>, origin='C:\\\\Users\\\\Doly\\\\Anaconda3\\\\lib\\\\site-packages\\\\numpy\\\\random\\\\_pcg64.cp37-win_amd64.pyd')"
