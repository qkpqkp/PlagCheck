...
class SvnAuth(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'py._path.svnwc', '__doc__': ' container for auth information for Subversion ', '__init__': <function SvnAuth.__init__ at 0x0000014C04097EA0>, 'makecmdoptions': <function SvnAuth.makecmdoptions at 0x0000014C04097F28>, '__str__': <function SvnAuth.__str__ at 0x0000014C040A3048>, '__dict__': <attribute '__dict__' of 'SvnAuth' objects>, '__weakref__': <attribute '__weakref__' of 'SvnAuth' objects>})"
...
class svnurl(__py__path_svnwc.SvnPathBase):
    ...
    _lsnorevcache = None # (!) real value is '<py._path.cacheutil.AgingCache object at 0x0000014C03CA2748>'
    _lsrevcache = None # (!) real value is '<py._path.cacheutil.BuildcostAccessCache object at 0x0000014C03CA2E48>'
