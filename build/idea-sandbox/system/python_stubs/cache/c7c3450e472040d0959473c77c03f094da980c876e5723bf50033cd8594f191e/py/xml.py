...
class raw(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'py._xmlgen', '__doc__': 'just a box that can contain a unicode string that will be\\n    included directly in the output', '__init__': <function raw.__init__ at 0x0000014C03A8D268>, '__dict__': <attribute '__dict__' of 'raw' objects>, '__weakref__': <attribute '__weakref__' of 'raw' objects>})"
...
class Tag(list):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'py._xmlgen', 'Attr': <class 'py._xmlgen.Tag.Attr'>, '__init__': <function Tag.__init__ at 0x0000014C03A8AF28>, '__unicode__': <function Tag.__unicode__ at 0x0000014C03A8D048>, '__str__': <function Tag.__unicode__ at 0x0000014C03A8D048>, 'unicode': <function Tag.unicode at 0x0000014C03A8D0D0>, '__repr__': <function Tag.__repr__ at 0x0000014C03A8D158>, '__dict__': <attribute '__dict__' of 'Tag' objects>, '__weakref__': <attribute '__weakref__' of 'Tag' objects>, '__doc__': None})"
