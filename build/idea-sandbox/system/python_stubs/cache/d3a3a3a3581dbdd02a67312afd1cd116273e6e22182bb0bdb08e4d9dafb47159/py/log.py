...
class Path(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'py._log.log', '__doc__': ' log consumer that opens and writes to a Path ', '__init__': <function Path.__init__ at 0x0000025ED4A9B730>, '_openfile': <function Path._openfile at 0x0000025ED4A9B7B8>, '__call__': <function Path.__call__ at 0x0000025ED4A9B840>, '__dict__': <attribute '__dict__' of 'Path' objects>, '__weakref__': <attribute '__weakref__' of 'Path' objects>})"
...
class Producer(object):
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'py._log.log\', \'__doc__\': " (deprecated) Log producer API which sends messages to be logged\\n        to a \'consumer\' object, which then prints them to stdout,\\n        stderr, files, etc. Used extensively by PyPy-1.1.\\n    ", \'Message\': <class \'py._log.log.Message\'>, \'keywords2consumer\': {}, \'__init__\': <function Producer.__init__ at 0x0000025ED4A939D8>, \'__repr__\': <function Producer.__repr__ at 0x0000025ED4A93C80>, \'__getattr__\': <function Producer.__getattr__ at 0x0000025ED4A9B048>, \'__call__\': <function Producer.__call__ at 0x0000025ED4A9B0D0>, \'__dict__\': <attribute \'__dict__\' of \'Producer\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'Producer\' objects>})'
...
class Syslog(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'py._log.log', '__doc__': ' consumer that writes to the syslog daemon ', '__init__': <function Syslog.__init__ at 0x0000025ED4A9B9D8>, '__call__': <function Syslog.__call__ at 0x0000025ED4A9BA60>, '__dict__': <attribute '__dict__' of 'Syslog' objects>, '__weakref__': <attribute '__weakref__' of 'Syslog' objects>})"
