...
class ForkedFunc(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'py._process.forkedfunc', 'EXITSTATUS_EXCEPTION': 3, '__init__': <function ForkedFunc.__init__ at 0x000001F4FCBA2AE8>, '_child': <function ForkedFunc._child at 0x000001F4FCBA2B70>, 'waitfinish': <function ForkedFunc.waitfinish at 0x000001F4FCBA2BF8>, '_removetemp': <function ForkedFunc._removetemp at 0x000001F4FCBA2C80>, '__del__': <function ForkedFunc.__del__ at 0x000001F4FCBA2D08>, '__dict__': <attribute '__dict__' of 'ForkedFunc' objects>, '__weakref__': <attribute '__weakref__' of 'ForkedFunc' objects>, '__doc__': None})"
