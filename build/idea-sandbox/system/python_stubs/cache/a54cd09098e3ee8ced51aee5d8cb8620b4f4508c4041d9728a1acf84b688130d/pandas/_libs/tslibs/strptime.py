...
# from C:\Users\Doly\Anaconda3\lib\site-packages\pandas\_libs\tslibs\strptime.cp37-win_amd64.pyd
# by generator 1.147
...
import locale as locale # C:\Users\Doly\Anaconda3\lib\locale.py
import calendar as calendar # C:\Users\Doly\Anaconda3\lib\calendar.py
...
class LocaleTime(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'pandas._libs.tslibs.strptime', '__doc__': '\\n    Stores and handles locale-specific information related to time.\\n\\n    ATTRIBUTES:\\n        f_weekday -- full weekday names (7-item list)\\n        a_weekday -- abbreviated weekday names (7-item list)\\n        f_month -- full month names (13-item list; dummy value in [0], which\\n                    is added by code)\\n        a_month -- abbreviated month names (13-item list, dummy value in\\n                    [0], which is added by code)\\n        am_pm -- AM/PM representation (2-item list)\\n        LC_date_time -- format string for date/time representation (string)\\n        LC_date -- format string for date representation (string)\\n        LC_time -- format string for time representation (string)\\n        timezone -- daylight- and non-daylight-savings timezone representation\\n                    (2-item list of sets)\\n        lang -- Language used by instance (2-item tuple)\\n    ', '__init__': <cyfunction LocaleTime.__init__ at 0x000001975C30C550>, '_LocaleTime__pad': <cyfunction LocaleTime.__pad at 0x000001975C30C608>, '_LocaleTime__calc_weekday': <cyfunction LocaleTime.__calc_weekday at 0x000001975C30C6C0>, '_LocaleTime__calc_month': <cyfunction LocaleTime.__calc_month at 0x000001975C30C778>, '_LocaleTime__calc_am_pm': <cyfunction LocaleTime.__calc_am_pm at 0x000001975C30C830>, '_LocaleTime__calc_date_time': <cyfunction LocaleTime.__calc_date_time at 0x000001975C30C8E8>, '_LocaleTime__calc_timezone': <cyfunction LocaleTime.__calc_timezone at 0x000001975C30C9A0>, '__dict__': <attribute '__dict__' of 'LocaleTime' objects>, '__weakref__': <attribute '__weakref__' of 'LocaleTime' objects>})"
...
class TimeRE(dict):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'pandas._libs.tslibs.strptime', '__doc__': '\\n    Handle conversion from format directives to regexes.\\n\\n    Creates regexes for pattern matching a string of text containing\\n    time information\\n    ', '__init__': <cyfunction TimeRE.__init__ at 0x000001975C30CA58>, '__getitem__': <cyfunction TimeRE.__getitem__ at 0x000001975C30CB10>, '_TimeRE__seqToRE': <cyfunction TimeRE.__seqToRE at 0x000001975C30CBC8>, 'pattern': <cyfunction TimeRE.pattern at 0x000001975C30CC80>, 'compile': <cyfunction TimeRE.compile at 0x000001975C30CD38>, '__dict__': <attribute '__dict__' of 'TimeRE' objects>, '__weakref__': <attribute '__weakref__' of 'TimeRE' objects>})"
...
_cache_lock = None # (!) real value is '<unlocked _thread.lock object at 0x000001975C234238>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001975C252908>'

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.strptime', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001975C252908>, origin='C:\\\\Users\\\\Doly\\\\Anaconda3\\\\lib\\\\site-packages\\\\pandas\\\\_libs\\\\tslibs\\\\strptime.cp37-win_amd64.pyd')"
