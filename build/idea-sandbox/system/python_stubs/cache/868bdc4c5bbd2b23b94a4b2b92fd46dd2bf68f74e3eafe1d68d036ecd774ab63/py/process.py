...
class ForkedFunc(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'py._process.forkedfunc', 'EXITSTATUS_EXCEPTION': 3, '__init__': <function ForkedFunc.__init__ at 0x0000028201877158>, '_child': <function ForkedFunc._child at 0x00000282018771E0>, 'waitfinish': <function ForkedFunc.waitfinish at 0x0000028201877268>, '_removetemp': <function ForkedFunc._removetemp at 0x00000282018772F0>, '__del__': <function ForkedFunc.__del__ at 0x0000028201877378>, '__dict__': <attribute '__dict__' of 'ForkedFunc' objects>, '__weakref__': <attribute '__weakref__' of 'ForkedFunc' objects>, '__doc__': None})"
