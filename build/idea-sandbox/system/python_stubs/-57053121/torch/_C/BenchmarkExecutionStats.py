...
class BenchmarkExecutionStats(__pybind11_builtins.pybind11_object):
    # no doc
    def __init__(self, *args, **kwargs): # real signature unknown
        pass

    latency_avg_ms = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
