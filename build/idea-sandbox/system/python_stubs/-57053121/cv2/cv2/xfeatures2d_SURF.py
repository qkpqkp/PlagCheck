...
class xfeatures2d_SURF(__cv2.Feature2D):
    # no doc
    def create(self, hessianThreshold=None, nOctaves=None, nOctaveLayers=None, extended=None, upright=None): # real signature unknown; restored from __doc__
        """
    ...
    def getHessianThreshold(self): # real signature unknown; restored from __doc__
        """
    ...
    def setHessianThreshold(self, hessianThreshold): # real signature unknown; restored from __doc__
        """
    ...
    def setNOctaveLayers(self, nOctaveLayers): # real signature unknown; restored from __doc__
        """
    ...
    def setNOctaves(self, nOctaves): # real signature unknown; restored from __doc__
        """
