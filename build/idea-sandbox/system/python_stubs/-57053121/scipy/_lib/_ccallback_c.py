...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001CBCF527B70>'

__pyx_capi__ = {
    'plus1_cython': None, # (!) real value is '<capsule object "double (double, int *, void *)" at 0x000001CBCF504780>'
    'plus1b_cython': None, # (!) real value is '<capsule object "double (double, double, int *, void *)" at 0x000001CBCF5047B0>'
    'plus1bc_cython': None, # (!) real value is '<capsule object "double (double, double, double, int *, void *)" at 0x000001CBCF5047E0>'
    'sine': None, # (!) real value is '<capsule object "double (double, void *)" at 0x000001CBCF504810>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='scipy._lib._ccallback_c', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001CBCF527B70>, origin='C:\\\\Users\\\\Doly\\\\Anaconda3\\\\lib\\\\site-packages\\\\scipy\\\\_lib\\\\_ccallback_c.cp37-win_amd64.pyd')"
